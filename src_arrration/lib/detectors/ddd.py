...
from models.decode import ddd_decode, sincos_3d_decode
from models.utils import flip_tensor
from utils.image import get_affine_transform
from utils.postprocess3d import ddd_post_process_sincos_3d as ddd_post_process
...
class DddDetector(BaseDetector):
    ...
    def process(self, images, return_time=False):
        with torch.no_grad():
            ...
            output['conf'] = output['conf'].sigmoid_()
            ...
            dets = sincos_3d_decode(output['hm'], output['reg_3d'],output['conf'])
    ...
    def post_process(self, dets, meta, scale=1):
        ...
        detections = ddd_post_process(
            dets, [meta['c']], [meta['s']], [meta['calib']], self.opt)
    ...
    def merge_outputs(self, detections):
        ...
        if len(results > 0):
            keep_inds = (results[:, -1] > self.opt.peak_thresh)
